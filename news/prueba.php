		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					<h1 class="text-center"><strong>Grupo Codelse</strong></h1>
			...
			<div class="row well">
				...
				<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 ">		
					<h3><strong>CODELSE es una empresa líder en el mercado de las instalaciones especiales con más de 30 años de experiencia en el sector.</strong></h3>
					<p></p>	
			...
			<div class="pie">
				<div class="row well">
					...
					<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
						<img class="imagen-responsive" src="img/Aenor.png" alt="Aenor" />
					</div>
				</div>
			</div>
		</div>
