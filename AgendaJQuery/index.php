...
if (isset($_SESSION['username'])) {
    ...
    ////////////////////////////////////////////////////////////////////////////////
        ...
        $ctv=md5($_POST["password"]);
        echo $usuario."USUARIO".$ctv."CTVVVVV";
    ...
    ////////////////////////////////////////////////////////////////////////////
        ...
        if($tabla == "0"){
            ...
            $estado=BD::nuevoEmpleado($sesion, $dni, $nombre, $apellido1, $apellido2, $localidad, $movil, $saldo, $comentarios, $tabla, $usuario);
    ...
    ////////////////////////////////////////////////////////////////////////////
        ...
        $sesion=$_SESSION["usuario"];
        $empleado=BD::UnEmpleado($_POST["empleado"]);
    ...
    ////////////////////////////////////////////////////////////////////////////
        ...
        $sesion=$_SESSION["usuario"];
        $estado=BD::modificaEmpleado($sesion, $cod, $nombre, $dni, $apellido1, $apellido2, $localidad, $movil, $saldo, $comentarios, $usuario);
    ...
    ////////////////////////////////////////////////////////////////////////////
    ///////   GENERAR WORD DE VACACIONES !!!!!!    /////////////////////////////
    ////////////////////////////////////////////////////////////////////////////

    }else if(isset($_POST["word"])){
        require_once "include/Introdicir.php";
        $empleados=BD::UnEmpleado($cod_emple);
