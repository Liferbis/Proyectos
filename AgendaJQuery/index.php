...
<head>
  ...
  <link rel="stylesheet" href="libreria/jqm-datebox-1.4.5.min.css">
  ...
  <script src="libreria/jqm-datebox.core.min.js"></script>
  <script src="libreria/jqueryDateBox.js"></script>
  <script src="libreria/jquery.mobile.datebox.i18n.en_US.utf8.js"></script>
  <!--<script src="../libreria/jquery.mobile.datebox.i18n.es-ES.utf8.js"></script>-->
...
<div  data-role="content">
  ...
  <fieldset >
      ...
      <div class="ui-field-contain" id='fecha_Fin'>
          <label for="FechaI"><h3>Fecha hasta:</h3></label>
  ...
  <div class="ui-grid-b">
      <div class="ui-block-a">
        <a href="#intro" data-role="button" data-theme="c" data-icon="bullets">Aceptar y Generar Word</a>
    </div>
    <div class="ui-block-b" >
        <a href="#two" data-role="button" data-theme="f" data-icon="delete" >Cancelar</a>
    </div>
    <div class="ui-block-c" >
        <a href="#correcto" data-role="button" data-theme="g" data-icon="check">Aceptar</a>
    </div>
</div>
</form>
</div>
...
<div  data-role="content">
    ...
    <div class="ui-grid-a">
        <div class="ui-block-a">
            <a href="#Agenda" data-role="button" data-theme="e" data-icon="plus">Vacaciones</a>
        </div>
        <div class="ui-block-b" >
            <a href="#two" data-role="button" data-theme="e" data-icon="home" >Pagina principal</a>
        </div>
    </div>
</div>
