...
<body>
	...
	<div id="box-img" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	        <div class="item">
	            <img data-src="holder.js/900x500/auto/#777:#7a7a7a/text:First slide" class="img-responsive" alt="First slide" src="img/Lidia (1).jpg">
	            <div class="container">
	        ...
	        <div class="item">
	            <img data-src="holder.js/900x500/auto/#666:#6a6a6a/text:Second slide" alt="Second slide" src="img/Lidia (2).jpg">
	            <div class="container">
	                <div class="carousel-caption">
	                    <h1>Hobbies</h1>
	                </div>
	        ...
	        <div class="item active">
	            <img data-src="holder.js/900x500/auto/#555:#5a5a5a/text:Third slide" alt="Third slide" src="img/Lidia (3).jpg">
	            <div class="container">
	                <div class="carousel-caption">
	                    <h1>Esta soy yo</h1>
	                </div>
